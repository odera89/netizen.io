    ...
    <?php do_action( 'oqp_before_content' );?>
        ...
        <div id="oqp_post_<?php the_ID();?>" <?php post_class(); ?> rel="<?php the_ID();?>">
            ...
            <?php oqp_post_review();?>
                ...
                <form action="<?php echo oqp_get_base_link();?>" id="oqp_form_<?php echo $oqp_form->page_id;?>" class="oqp-form" method="post" name="oqp_form_<?php echo $oqp_form->page_id;?>" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        <div class="submit" id="previous-next">
                                ...
                                if (!$oqp_form->loaded_post->ID) {
                                        ...
                                        wp_nonce_field( 'oqp-edit-post'.get_the_ID().'-blog-'.$oqp_form->args['blog_id'] );

                                       

                                        ?>
                                        <input type="hidden" name="oqp-post-id" value="<?php the_ID();?>"/>
                                        <?php
                                }
                                ?>
                                <input type="hidden" name="oqp_action" value="<?php echo $oqp_form->action;?>"/>
                                 <input type="hidden" name="oqp_step" value="<?php echo $oqp_form->step->slug;?>"/>
                                <input type="hidden" name="oqp-form-id" value="<?php echo $oqp_form->page_id;?>"/>
                                <?php //wp_referer_field();?>
                                <?php do_action('oqp_form_after_fields');?>

                                <?php oqp_form_buttons();?>
